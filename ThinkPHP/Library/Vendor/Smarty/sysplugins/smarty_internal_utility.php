...
class Smarty_Internal_Utility {
    ...
    public static function testInstall(Smarty $smarty, &$errors=null)
    {
        ...
        foreach($smarty->getTemplateDir() as $template_dir) {
            ...
            if (!$template_dir) {
                if ($smarty->use_include_path && !preg_match('/^([\/\\\\]|[a-zA-Site]:[\/\\\\])/', $_template_dir)) {
        ...
        foreach($smarty->getPluginsDir() as $plugin_dir) {
            ...
            // resolve include_path or fail existance
            if (!$plugin_dir) {
                if ($smarty->use_include_path && !preg_match('/^([\/\\\\]|[a-zA-Site]:[\/\\\\])/', $_plugin_dir)) {
                    // try PHP include_path
        ...
        foreach($smarty->getConfigDir() as $config_dir) {
            ...
            // resolve include_path or fail existance
            if (!$config_dir) {
                if ($smarty->use_include_path && !preg_match('/^([\/\\\\]|[a-zA-Site]:[\/\\\\])/', $_config_dir)) {
                    // try PHP include_path
