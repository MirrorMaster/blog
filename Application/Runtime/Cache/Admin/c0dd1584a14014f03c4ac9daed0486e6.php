...
<div class="content col-lg-11">
    <span class="lead text-primary">修改文章</span>
    <form  enctype="multipart/form-data" class="form-horizontal">
            <div class="form-group">
                <input name="id" type="hidden" value="<?php echo ($list['id']); ?>">
                <label class="control-label col-lg-2">文章标题:</label>
                <div class="col-lg-5">
                    <input value="<?php echo ($list['title']); ?>" name="title" type="text" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-lg-2">文章副标题:</label>
                <div class="col-lg-5">
                    <input value="<?php echo ($list['small_title']); ?>" name="small_title" type="text" class="form-control">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-5">
                    ...
                    <input type="hidden" name="thumb"  id="thumb" class="thumb"  value="<?php echo ($list['thumb']); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-lg-2 control-label">描述</label>
                <div class="col-lg-5">
                    <input value="<?php echo ($list['description']); ?>" name="description" type="text" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label class="col-lg-2 control-label">内容</label>
                <div class="col-lg-5">
                        <textarea name="content" id="editor" class="form-control"><?php echo ($content['content']); ?></textarea>
                </div>
            </div>
        <button type="button" class="bai_ad btn btn-primary col-xs-12 col-lg-4 col-lg-push-2">完成</button>
    </form>
</div>
<div/>
<div/>
<script>
    var SCRIPT = {
        ...
        'save_url' : '/blog/admin.php/essay/editSave'
    }
