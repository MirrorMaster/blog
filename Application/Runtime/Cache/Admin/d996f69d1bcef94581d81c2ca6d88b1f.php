...
<div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="content col-lg-11">
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                            ...
                            <td>
                                <a style="cursor: pointer;" class="del" title="删除" data-id = <?php echo ($vo["id"]); ?>><span style="color: #000;" class="glyphicon glyphicon-remove"></span></a>
                                <a href="/blog/admin.php/essay/edit?id=<?php echo ($vo["id"]); ?>"  style="cursor: pointer"  title="更改"><span  style="color:#000"  class="glyphicon glyphicon-italic"></span></a>
                                <a href="/blog/index.php/index/read?id=<?php echo ($vo["id"]); ?>"  style="cursor: pointer"  title="更改"><span  style="color:#000"  class="glyphicon glyphicon-eye-open"></span></a>
                            </td>
            ...
            <a href="/blog/admin.php/essay/add" class="btn btn-primary">添加文章</a>
        </div>
    <div/>
<div/>
<script>
    var SCRIPT = {
        'delete_url' : '/blog/admin.php/essay/del'
    }
</script>
